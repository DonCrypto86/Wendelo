...
export default function Header() {
  return (
    <header className="nav shell">
      <a href="/de" className="brand" aria-label="WENDELO Start">
      ...
      <nav><a href="/de#como-funciona">So funktioniert's</a><a href="/de#soluciones">Lösungen</a><a href="/de#preguntas">Fragen</a><a href="/de#contacto">Kontakt</a><a href="/de#recomienda">Empfehlen &amp; verdienen</a></nav>
