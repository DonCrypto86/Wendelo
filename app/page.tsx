...
<nav><a href="#como-funciona">Cómo funciona</a><a href="#soluciones">Soluciones</a><a href="#preguntas">Preguntas</a><a href="#contacto">Contacto</a><a href="#recomienda">Recomendá y ganá</a></nav>
...
<section className="referral shell" id="recomienda">
<div className="sectionHead center"><span className="eyebrow">PROGRAMA DE REFERIDOS</span><h2>Recomendá WENDELO y ganá</h2><p>Compartí tu link de referido: ganás el <strong>15%</strong> de la cuota de implementación (Gs. 90.000) por cada negocio que se registre. ¿Ya sos cliente de WENDELO? Ganás el <strong>20%</strong> (Gs. 120.000). No hace falta ser cliente para participar.</p></div>
