...
<div className="sectionHead center"><span className="eyebrow">PROGRAMA DE REFERIDOS</span><h2>Recomendá WENDELO y ganá</h2><p>Compartí tu link de referido: ganás el <strong>15%</strong> de la cuota de implementación (Gs. 90.000) por cada negocio que se registre.</p></div>
